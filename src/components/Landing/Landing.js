...
const Landing = () => {
    return (
        <section className="Landing">
            ...
            <p className="Landing__paragraph">We are Focussed on creating the best experience for our clients and their customers. Using modern technlogies to provide an enjoyable and unique experience to our users.</p>
